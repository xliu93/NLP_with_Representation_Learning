...
record_save_path = util.get_results_folder(base_path='/scratch/xl2053/nlp/hw2_data/results_rnn/')  # or base_path=DATA_PATH
...
pd.DataFrame.from_records(tuning_records).to_csv(record_save_path + 'rnn_reg_hparams.csv')
logger.info("Output directory (loss history, accuracy history, checkpoints): {}".format(record_save_path))
